...
public class App2 
{
    public static void main( String[] args ) throws Exception
    {
		...
		new ClubXMLReader().loadFromXML(new File("data/input/fifa17.xml"), "/clubs/club", ds1);
		ds1.printDataSetDensityReport();

		FusibleDataSet<Club, Attribute> ds2 = new FusibleHashedDataSet<>();
		new ClubXMLReader().loadFromXML(new File("data/input/fut17.xml"), "/clubs/club", ds2);
		ds2.printDataSetDensityReport();

		FusibleDataSet<Club, Attribute> ds3 = new FusibleHashedDataSet<>();
		new ClubXMLReader().loadFromXML(new File("data/input/stadium.xml"), "/clubs/club", ds3);
		ds3.printDataSetDensityReport();
		
		FusibleDataSet<Club, Attribute> ds4 = new FusibleHashedDataSet<>();
		new ClubXMLReader().loadFromXML(new File("data/input/transfermarkt.xml"), "/clubs/club", ds4);
		...
		correspondences.loadCorrespondences(new File("data/correspondences/fut17_trans_correspondences.csv"), ds2, ds4);
		...
		strategy.addAttributeFuser(Club.NAME, null, new NameEvaluationRule());
